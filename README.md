...
| [subagents](extensions/subagents/) | `subagent`, `task_batch`, `/subagent` | Субагенты: интерактивные в WezTerm-панелях (спавн/steer/resume, живой статус) + headless-батчи single/parallel/chain (Windows + pwsh) |
