...
| [subagents](extensions/subagents/) | `subagent`, `task_batch`, `/subagent` | Субагенты: интерактивные в терминальных панелях — WezTerm или herdr (спавн/steer/resume, живой статус) + headless-батчи single/parallel/chain (Windows + pwsh) |
